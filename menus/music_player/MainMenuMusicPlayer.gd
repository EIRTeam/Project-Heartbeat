...
func set_song(song: HBSong, length: float):
	var playback_max_label = get_node("MarginContainer/VBoxContainer/HBoxContainer2/PlaybackMaxLabel")


	var song_title_label = get_node("MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer/SongLabel")
	var song_artist_label = get_node("MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer/ArtistLabel")
...
func set_time(time: float):
	var playback_current_time_label = get_node("MarginContainer/VBoxContainer/HBoxContainer2/PlaybackCurrentTimeLabel")
	playback_current_time_label.text = format_time(time)
	var playback_progress_bar = get_node("MarginContainer/VBoxContainer/ProgressBar")
