...
func fill_localized_arrays():
	...
	action_names = {
		...
		"editor_scroll_left": tr("Scroll the timeline to the left"),
		"editor_scroll_right": tr("Scroll the timeline to the right"),
		"editor_move_playhead_left": tr("Snap the playhead to the previous beat"),
		"editor_move_playhead_right": tr("Snap the playhead to the next beat"),
		"editor_move_playhead_left_bar": tr("Snap the playhead to the previous bar"),
		"editor_move_playhead_right_bar": tr("Snap the playhead to the next bar"),
		#  Menus
		...
		"editor_make_arc_cw": tr("Make arc clockwise"),
		"editor_make_arc_ccw": tr("Make arc counter-clockwise"),
		"editor_make_arc_cw_inside": tr("Make arc clockwise from the inside"),
		"editor_make_arc_ccw_inside": tr("Make arc counter-clockwise from the inside"),
