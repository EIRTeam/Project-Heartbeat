...
func fill_localized_arrays():
	...
	action_names = {
		...
		"pause": tr("Pause"),
		"editor_quick_lyric": "Quick lyric",
		"editor_quick_phrase_start": "Quick phrase start",
		"editor_quick_phrase_end": "Quick phrase end",
		"editor_select_all": "Select all",
		"editor_playtest": "Playtest",
		"editor_arrange_l": "Arrange left",
		"editor_arrange_r": "Arrange right",
		"editor_arrange_u": "Arrange up",
		"editor_arrange_d": "Arrange down",
		"editor_arrange_ul": "Arrange up left",
		"editor_arrange_ur": "Arrange up right",
		"editor_arrange_dl": "Arrange down left",
		"editor_arrange_dr": "Arrange down right",
		"editor_arrange_center": "Arrange center",
		"editor_flip_v": "Flip vertical",
		"editor_flip_h": "Flip horizontal",
		"editor_flip_angle": "Flip angle",
		"editor_flip_oscillation": "Flip oscillation",
		"editor_make_circle_c": "Make circle clockwise",
		"editor_make_circle_cc": "Make circle counter-clockwise",
