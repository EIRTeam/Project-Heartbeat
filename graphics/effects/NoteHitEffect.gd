...
func play_effect():
	...
	tween.interpolate_property(note_icon, "modulate:a", 0.75, 0.0, 0.7)
	...
	tween.interpolate_property(note_loop, "modulate:a", 0.6, 0.0, 0.7)
	...
	tween.interpolate_property(note_flare, "modulate:a", 0.4, 0.0, 0.4)
